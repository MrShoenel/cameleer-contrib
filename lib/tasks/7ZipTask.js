...
, { ResolvedConfig, SubClassRegister, Task, TaskConfigSchema } = require('cameleer')
, { ProcessWrapper, ProgressNumeric, Resolve } = require('sh.orchestration-tools');
...
class SevenZipTaskResolvedConfig extends ResolvedConfig {
  ...
  async resolveAll() {
    ...
    // TODO: Try to obtain progress from 7z and update this.
...
SubClassRegister.registerSubclass(Task, SevenZipTask);
SubClassRegister.registerSubclass(ResolvedConfig, SevenZipTaskResolvedConfig);
